...
public class DynamicPlaylistSession {
    ...
    DynamicPlaylistSession(ServiceExecutor en, String sessionID) {
        this.en = en;
     ...
     */
	public void restart(Params p) throws ServiceException {
     ...
     * @throws EchoNestException
     */
    public Playlist next(int results, int lookahead) throws ServiceException {
        Params p = new Params();
     ...
     * @throws EchoNestException 
     */
    public Playlist next() throws ServiceException {
        return next(1, 0);
    }
    /**
	...
	public void feedback(FeedbackType type, String id) throws ServiceException {
        Params p = new Params();
        p.set("session_id", sessionID);
     ...
     */
    @SuppressWarnings("unused")
	public void feedback(FeedbackType type, List<String> ids) throws ServiceException {
        Params p = new Params();
        p.set("session_id", sessionID);
     ...
     */
    @SuppressWarnings("unused")
	public void steer(Params p) throws ServiceException {
        p.set("session_id", sessionID);
        Map results = en.getCmd().sendCommand("playlist/dynamic/steer", p);
    }

    public Map info() throws ServiceException {
        Params p = new Params();
        p.set("session_id", sessionID);
        Map results = en.getCmd().sendCommand("playlist/dynamic/feedback", p);
        return results;
