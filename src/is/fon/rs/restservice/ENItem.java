...
public class ENItem {
    ...
    ENItem(ServiceExecutor en, String type, String path, Map data)
    ...
    ENItem(ServiceExecutor en, String type, String path, String id)
            throws ServiceException {
        this.en = en;
        this.type = type;
        this.path = path;
    ...
    ENItem(ServiceExecutor en, String type, String path, String nameOrID,
            boolean byName) throws ServiceException {
        this.en = en;
        this.type = type;
        this.path = path;
        if (byName) {
    ...
    ENItem(ServiceExecutor en, String type, String path, String id, String idType)
            throws ServiceException {
        this.en = en;
        this.type = type;
        this.path = path;
    ...
    private String findID() throws ServiceException {
        ...
        if (data.get("id") != null) {
            ...
            throw new ServiceException(
                    ServiceException.ERR_MISSING_PARAMETER, "Missing ID");
        }
    }

    protected final void refresh() throws ServiceException {
    ...
    public void fetchBuckets(String[] bucket) throws ServiceException {
    ...
    public void fetchBucket(String bucket) throws ServiceException {
        fetchBucket(bucket, bucket);
    }

    public void fetchBucket(String bucket, boolean force) throws ServiceException {
    ...
    public final Map getItemMap(String id) throws ServiceException {
        return getItemMap(id, (String) null);
    }

    public Map getItemMap(String id, String bucket) throws ServiceException {
